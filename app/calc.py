...
gui.mainloop()
This line starts the main event loop of the GUI, which listens for user interactions and updates the display accordingly. It keeps the window open and responsive until it is closed by the use
